...
void *handle_client(void *arg) {
    ...
    if (strstr(buffer, "GET / ") != NULL || strstr(buffer, "GET /index.html") != NULL || strstr(buffer, "GET /ui10.html") != NULL) {
        send_ui(client_sock);
        ...
        usleep(100000); // Simulate processing delay (100ms)
